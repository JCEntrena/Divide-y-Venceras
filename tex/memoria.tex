...
\subsection{Algoritmo}
  ...
  a él y otra con los elementos mayores que él. Así el pivote quedará en su posición ordenada. Si ésta es
  la posición $k$, habremos acabado; en otro caso, sólo tendremos que buscar recursivamente sobre la 
  sublista de elementos mayores, si el índice es menor que $k$, o la sublista de elementos menores, si el
